...
internal static partial class PostgresMigrationFoundationChecks
{
    public static async Task RunAsync()
    {
        ...
        await PostgresFighterLevelSealAllLevelsMigrationChecks.RunAsync();
        await PostgresFighterLevelSealRevisionMigrationChecks.RunAsync();
        await PostgresCapitalVendorItemMigrationChecks.RunAsync();
        ...
        CheckBattlefieldInstanceDialogueMigration();
        CheckLegacyInstanceDailyEntryMigration();
        CheckInstanceAttemptDialogueMigration();
        CheckLegacyInstanceOpalPaymentMigration();
        CheckInstanceFreeEntryDialogueMigration();
        CheckDuelArenaInitialActionsMigration();
        CheckDuelArenaServicesMigration();
