...
<<<<<<< HEAD
        ...
        // The stock client ships a second normal-storage teller per capital.
        // Both secondary tellers address the same character warehouse, so they
        // must be accepted with their own published interaction ID and must
        // keep advertising their own key as the client script.
        Check.True(
            WarehouseNpcProtocol.IsWarehouseEndpoint("Sparta_100", 5097) &&
            WarehouseNpcProtocol.IsWarehouseEndpoint("Athens_100", 5238) &&
            WarehouseNpcProtocol.ClientScriptKey("Sparta_100", 5097) ==
                "Sparta_100" &&
            WarehouseNpcProtocol.ClientScriptKey("Athens_100", 5238) ==
                "Athens_100",
            "secondary capital storage tellers are authoritative endpoints");
        Check.True(
            !WarehouseNpcProtocol.IsWarehouseEndpoint("Sparta_100", 5238) &&
            !WarehouseNpcProtocol.IsWarehouseEndpoint("Athens_100", 5097) &&
            !WarehouseNpcProtocol.IsWarehouseEndpoint("Sparta_100", 5096) &&
            !WarehouseNpcProtocol.IsWarehouseEndpoint("Athens_100", 5165) &&
