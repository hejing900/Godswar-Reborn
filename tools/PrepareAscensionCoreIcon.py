#!/usr/bin/env python3
"""Deterministically prepare the Ascension Core icon (Pillow12)."""
...
from ascension_core_icons import pack
...
def main() -> int:
    ...
    try:
        ...
        print(f"Ascension Core preparation failed: {error}", file=sys.stderr)
        return 1
