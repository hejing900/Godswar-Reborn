#!/usr/bin/env python3
"""Deterministically prepare the 27 reviewed Holy Stone/Spirit icons (Pillow12)."""
...
from holy_stone_icons.packing import pack
...
def main() -> int:
    ...
    try:
        ...
        print(f"Holy Stone artwork preparation failed: {error}", file=sys.stderr)
        return 1
