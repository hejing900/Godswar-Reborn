"""Disassemble the guild message handlers to recover the payload layouts.

Each case body reads the fields of its message struct, so the offsets and widths
it touches are the wire layout the server has to produce. This dumps the base
info family and the member list handler.
"""
...
SPANS = [
    (0x004EDA3B, 0x004EDB5A, "BASE_INFO + UPDATE_BASE_INFO/PART/PLACARD/BUILDING"),
    (0x004EDB5A, 0x004EDC77, "MEMBER_LIST"),
    (0x004EDC77, 0x004ED2A4, "MEMBER_ONE"),
]
