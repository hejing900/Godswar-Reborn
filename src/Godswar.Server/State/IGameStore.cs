...
<<<<<<< HEAD
    ...
    /// </summary>
    Task SaveCharacterQuestStateAsync(
        int accountId,
        int characterId,
    ...
    /// <summary>
    /// Credits a quest's silver and gold reward and returns the new balances.
    /// </summary>
    Task<CharacterWalletResult?> GrantQuestCurrencyAsync(
        int accountId,
        int characterId,
        int silver,
        int gold,
