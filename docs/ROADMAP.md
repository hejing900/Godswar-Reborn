...
- Opcode `10311` returns a live 14-byte server-time packet using current Unix
  time and the subtractive native bias inverse to the selected realm's
  startup-pinned IANA UTC offset.
